So you've started using `life` and want to show your gratitude to the project,
...
* Review the [documentation](https://lyz-code.github.io/life) and try to improve
    it.

# I know how to program in Python

If you have some python knowledge there are some additional ways to contribute.
We've ordered the [issues](https://github.com/lyz-code/life/issues) in
[milestones](https://github.com/lyz-code/life/milestones), check the issues in
the smaller one, as it's where we'll be spending most of our efforts. Try the
[good first
issues](https://github.com/lyz-code/life/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
...
[documentation](https://lyz-code.github.io/life) of the project, so think if
...
policy](https://github.com/lyz-code/life/security/policy) instead.**
...
Please try to always include the above unless you're unable to install `life` or know it's not relevant to your question or
feature request.

# Pull Requests

*life* is released regularly so you should see your
...
wanted"](https://github.com/lyz-code/life/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
label on github.
...
* Clone your fork and go into the repository directory:
    ...
    ```bash
    git clone git@github.com:<your username>/life.git
    cd life
    ```
...
* Install life, dependencies and configure the
    pre-commits:
...
* Fix formatting and imports: life uses
